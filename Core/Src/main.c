...
/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
#define counts_per_rev 20 //as we have 20 ticks in encoder and make the arr in ioc 20
/* USER CODE END PD */
...
Alcd_t lcd1 = {
		.Data_GPIO = GPIOA,
		.Data_GPIO_Start_Pin=2,
		.RS_GPIO= GPIOA,
		.RS_GPIO_Pin= GPIO_PIN_6,
		.EN_GPIO= GPIOA,
		.EN_GPIO_Pin= GPIO_PIN_7,
};
char degree_counter[20];
/* USER CODE END PV */
